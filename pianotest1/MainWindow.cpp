...
{
	if(note%12==0)	//도
		midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note-3, m_force);
	else if(note%12==1) //도 샾
		midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note-4, m_force);
	else if(note%12==2) //레
		midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note-3, m_force);
	...
	//if(note%12==0){	//도
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+4+octave, m_force);
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+6, m_force);
	//}
	//else if(note%12==1){ //도 샾
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+4+octave, m_force);
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+7, m_force);
	//}
	//else if(note%12==2){ //레
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+3+octave, m_force);
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+5, m_force);
	//}
	//else if(note%12==3){ //레 샾
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+4+octave, m_force);
	//	midiTrackAddMsg(m_midifile, 1, down ? msgNoteOn : msgNoteOff, note+7, m_force);
